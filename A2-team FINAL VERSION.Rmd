...
Up to this point, we explored three clustering algorithms - DBSCAN, CLARA and kmeans. The results from all the three of the algorithms were mixed and we ended up with some relatively strong clusters and a number of very weak data clusters. We will use the clValid function again in order to select the algorithm with the best result among the
