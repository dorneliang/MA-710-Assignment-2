...
Rule 2: The first rule tells us that 39% of all institutions are predominantly Certificate-degree institutions with missing values for the variable `CCBASIC`.

Rule 3: The first rule tells us that 39% of all institutions are predominantly Certificate-degree institutions with missing values for the variables `CURROPER` and `CCBASIC`.
